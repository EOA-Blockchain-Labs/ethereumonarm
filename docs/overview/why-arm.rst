...
.. [1] Power consumption measurements based on official specifications:
   
   * Rock 5B: `Radxa Rock 5B Specifications <https://wiki.radxa.com/Rock5/5b>`_
   * NanoPC T6: `FriendlyElec NanoPC-T6 Specifications <https://wiki.friendlyelec.com/wiki/index.php/NanoPC-T6>`_
   * Orange Pi 5 Plus: `Orange Pi 5 Plus Specifications <http://www.orangepi.org/html/hardWare/computerAndMicrocontrollers/details/Orange-Pi-5-plus.html>`_
   * Intel NUC and desktop PC power consumption: `Tom's Hardware Power Consumption Database <https://www.tomshardware.com/reviews/power-consumption-benchmarks>`_

.. [2] U.S. Energy Information Administration (EIA), Average Price of Electricity to Ultimate Customers:
   `EIA Electricity Data <https://www.eia.gov/electricity/monthly/epm_table_grapher.php?t=epmt_5_6_a>`_
   
   Note: $0.15/kWh is a conservative estimate. Actual rates vary by location (U.S. average ~$0.16/kWh, Europe ~$0.20-0.30/kWh).

.. [3] CO₂ emissions calculated using EPA's greenhouse gas equivalencies:
   
   * U.S. EPA: `Greenhouse Gas Equivalencies Calculator <https://www.epa.gov/energy/greenhouse-gas-equivalencies-calculator>`_
   * Emission factor: ~0.4 kg CO₂ per kWh (U.S. average grid mix)
   * Calculation: (100-300W PC - 10-15W ARM) × 8,760 hours/year × 0.4 kg CO₂/kWh = 400-1,000 kg CO₂/year

.. [4] Tree carbon sequestration rates:
   
   * U.S. Forest Service: `Carbon Storage in Trees <https://www.fs.usda.gov/ccrc/topics/carbon-storage>`_
   * Average tree absorbs ~20 kg CO₂ per year
   * Calculation: 400-1,000 kg CO₂ saved ÷ 20 kg CO₂/tree = 20-50 tree equivalents

.. [5] Ethereum client hardware requirements and sync times:
   
   * Geth Documentation: `Hardware Requirements <https://geth.ethereum.org/docs/getting-started/hardware-requirements>`_
   * Lighthouse Documentation: `System Requirements <https://lighthouse-book.sigmaprime.io/installation.html>`_
   * Community benchmarks: `Ethereum on ARM Community Reports <https://github.com/EOA-Blockchain-Labs/ethereumonarm/discussions>`_

.. [6] Total Cost of Ownership calculations:
   
   * Hardware pricing: Current market prices from major retailers (Amazon, Newegg, AliExpress)
   * Cloud VPS pricing: Based on AWS EC2, Google Cloud, and DigitalOcean pricing for equivalent specs (4-8 vCPU, 16GB RAM, 2TB storage)
   * Typical cloud VPS cost: $150-200/month for comparable performance
