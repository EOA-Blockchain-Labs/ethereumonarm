...
------------------------
Running an Ethereum node on an ARM board offers clear benefits, including energy efficiency, low cost, and silent operation. For a detailed explanation of these advantages, please visit our :doc:`Why ARM Boards? </overview/why-arm>` page.
...
To explore the full capabilities of our images, check out our :doc:`Main Features </overview/features>` page.
...
For a complete list of recommended devices and hardware requirements, please refer to our :doc:`Supported Hardware </overview/supported-hardware>` guide.
