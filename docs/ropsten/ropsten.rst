...
ecommend picking up an **AWS spot instance** to 
...
You will need the Kiln image in order to install the clients:
...
.. prompt:: bash $
  ...
  lighthouse-kl account validator import --directory=/home/ethereum/validator_keys --datadir=/home/ethereum/.lh-geth/ropsten/testnet-lh
...
.. prompt:: bash $
  ...
  validator-kl accounts import --keys-dir=/home/ethereum/validator_keys --wallet-dir /home/ethereum/.pry-geth/ropsten/testnet-pry
...
.. prompt:: bash $
  ...
  nimbus_beacon_node-kl deposits import /home/ethereum/validator_keys --data-dir=/home/ethereum/.nim-besu/ropsten/testnet-nim
...
.. prompt:: bash $
  ...
  sudo sed -i 's/changeme1/$KEYSTORE_FILE/' /etc/ethereum/ropsten/teku-geth.conf
  echo "$KEYSTORE_PASSWORD" > /home/ethereum/validator_keys/teku-password.txt
  sudo sed -i 's/changeme2/$YOUR_ETH_ADDRESS/' /etc/ethereum/ropsten/teku-geth.conf
