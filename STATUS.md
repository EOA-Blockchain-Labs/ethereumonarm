...
_Last updated: 2026-06-11 08:08:41 UTC_
...
| `dvt-obol` | `1.10.2` ([ObolNetwork/charon](https://github.com/ObolNetwork/charon)) | `1.10.1` | ❌ Outdated |
...
| `stakewise-operator` | `4.1.14` ([stakewise/v3-operator](https://github.com/stakewise/v3-operator)) | `4.1.14` | ✅ Up-to-date |
...
| `lighthouse` | `8.1.3` ([sigp/lighthouse](https://github.com/sigp/lighthouse)) | `8.1.3` | ✅ Up-to-date |
...
| `teku` | `26.4.0` ([ConsenSys/teku](https://github.com/ConsenSys/teku)) | `26.4.0` | ✅ Up-to-date |

## Layer 1 Execution

| Package | GitHub (Upstream) | Repo (Ethereum on ARM) | Status |
| :------- | :------------------ | :----------------------- | :------: |
| `besu` | `26.6.0` ([hyperledger/besu](https://github.com/hyperledger/besu)) | `26.6.0` | ✅ Up-to-date |
| `erigon` | `3.4.3` ([ledgerwatch/erigon](https://github.com/ledgerwatch/erigon)) | `3.4.3` | ✅ Up-to-date |
| `ethrex` | `16.0.0` ([lambdaclass/ethrex](https://github.com/lambdaclass/ethrex)) | `15.0.0` | ❌ Outdated |
...
| `reth` | `2.3.0` ([paradigmxyz/reth](https://github.com/paradigmxyz/reth)) | `2.2.0` | ❌ Outdated |
...
| Package | GitHub (Upstream) | Repo (Ethereum on ARM) | Status |
| :------- | :------------------ | :----------------------- | :------: |
| `arbitrum-nitro` | `3.10.2` ([OffchainLabs/nitro](https://github.com/OffchainLabs/nitro)) | `3.10.2` | ✅ Up-to-date |
...
| `optimism-op-node` | `1.19.0` ([ethereum-optimism/optimism#op-node](https://github.com/ethereum-optimism/optimism#op-node)) | `1.19.0` | ✅ Up-to-date |
| `optimism-op-reth` | `2.3.0` ([paradigmxyz/reth](https://github.com/paradigmxyz/reth)) | `1.10.2` | ❌ Outdated |
| `starknet-juno` | `0.16.2` ([NethermindEth/juno](https://github.com/NethermindEth/juno)) | `0.16.0` | ❌ Outdated |
| `starknet-madara` | `0.10.2` ([madara-alliance/madara](https://github.com/madara-alliance/madara)) | `0.10.2` | ✅ Up-to-date |
| `starknet-pathfinder` | `0.22.5` ([equilibriumco/pathfinder](https://github.com/equilibriumco/pathfinder)) | `0.22.3` | ❌ Outdated |

## Web3

| Package | GitHub (Upstream) | Repo (Ethereum on ARM) | Status |
| :------- | :------------------ | :----------------------- | :------: |
| `bee` | `2.8.0` ([ethersphere/bee](https://github.com/ethersphere/bee)) | `2.8.0` | ✅ Up-to-date |
| `kubo` | `0.42.0` ([ipfs/kubo](https://github.com/ipfs/kubo)) | `0.41.0` | ❌ Outdated |
