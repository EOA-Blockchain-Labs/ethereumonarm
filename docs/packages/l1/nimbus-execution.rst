...
This package provides the Nimbus Ethereum execution client (Nimbus-eth1), packaged for Ethereum on ARM.

Services
--------

This package installs systemd services for various networks and a proxy service. The services are disabled by default.
