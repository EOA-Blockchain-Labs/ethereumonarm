...
- ``nethermind-hoodi.service`` (Hoodi Testnet)
- ``nethermind-op.service`` (Optimism Mainnet)
- ``nethermind-op-sepolia.service`` (Optimism Sepolia)
...
- **Hoodi**: ``/etc/ethereum/nethermind-hoodi.conf``
- **Optimism**: ``/etc/ethereum/nethermind-op.conf``
- **Optimism Sepolia**: ``/etc/ethereum/nethermind-op-sepolia.conf``
...
- ``/home/ethereum/.nethermind-hoodi`` (Hoodi Testnet)
- ``/home/ethereum/.nethermind-op`` (Optimism)
- ``/home/ethereum/.nethermind-op-sepolia`` (Optimism Sepolia)
