...
- ``lighthouse-beacon-hoodi.service`` (Holesky Testnet)
- ``lighthouse-beacon-hoodi-mev.service`` (Holesky + MEV-Boost)
...
- ``lighthouse-validator-hoodi.service`` (Holesky Testnet)
- ``lighthouse-validator-hoodi-mev.service`` (Holesky + MEV-Boost)
