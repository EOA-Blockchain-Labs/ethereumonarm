...
_Last updated: 2026-03-08 04:48:10 UTC_
...
| `dvt-obol` | `1.9.1` ([ObolNetwork/charon](https://github.com/ObolNetwork/charon)) | `1.9.0` | ❌ Outdated |
...
| Package | GitHub (Upstream) | Repo (Ethereum on ARM) | Status |
| :------- | :------------------ | :----------------------- | :------: |
| `besu` | `26.2.0` ([hyperledger/besu](https://github.com/hyperledger/besu)) | `26.1.0` | ❌ Outdated |
...
| `nethermind` | `1.36.1` ([NethermindEth/nethermind](https://github.com/NethermindEth/nethermind)) | `1.36.0` | ❌ Outdated |
