...
*   **Prometheus and Grafana:**
    ...
    *   **Pre-built Dashboards:**  The **Ethereum on ARM** package includes custom Grafana dashboards specifically designed for monitoring your Geth, Prysm, and Optimism nodes. These can be imported directly into Grafana. You can find these dashboards in ``/usr/lib/ethereumonarm/Grafana dashboards/``.
