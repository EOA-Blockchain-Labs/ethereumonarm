...
This package provides the StakeWise V3 Operator, a tool for managing StakeWise V3 validators, packaged for Ethereum on ARM.
...
To enable the service, run:
    sudo systemctl enable --now stakewise-operator.service
